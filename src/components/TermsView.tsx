      ...
      <main className="max-w-4xl mx-auto px-6 py-16 text-slate-700 leading-loose">
        <div className="bg-white rounded-[32px] p-8 md:p-12 shadow-sm border border-slate-200">
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              مرحباً بك في منصة <strong>ريستو كلاود (RestoCloud) (RestoCloud)</strong>. باستخدامك لهذه المنصة، فإنك توافق على الامتثال والالتزام بشروط الاستخدام الماثلة. تُطبق هذه الشروط على جميع المستخدمين، بما في ذلك أصحاب المطاعم، ومديري الفروع، والموظفين، والزبائن الذين يستخدمون المنصة لطلب الطعام.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              كمزود لبرنامج نقاط البيع (POS)، تلتزم ريستو كلاود (RestoCloud) بتوفير الأدوات اللازمة لإصدار فواتير إلكترونية متوافقة مع المرحلة الأولى (FATOORA). تقع مسؤولية إدخال الرقم الضريبي الصحيح واسم المنشأة التجاري بدقة على عاتق المشترك (صاحب المطعم).
            </p>
          </section>
