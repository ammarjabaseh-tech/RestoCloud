...
const landingTranslations = {
  ar: {
    ...
    planStarterPriceVal: "199",
    planStarterPriceUnit: " ر.س / شهرياً",
  ...
  en: {
    ...
    planStarterPriceVal: "$59",
    planStarterPriceUnit: " / month",
  ...
  tr: {
    ...
    planStarterPriceVal: "1490 TL",
    planStarterPriceUnit: " / aylık",
    ...
    planProPriceVal: "2990 TL",
    planProPriceUnit: " / aylık",
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-black tracking-tight text-white">{t.brand}</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold transition-all border border-white/10 bg-white/5 hover:bg-white/10 text-white cursor-pointer"
              >
            ...
            <button
              ...
              className="text-sm font-bold text-slate-300 hover:text-white transition-colors hidden sm:block cursor-pointer"
            >
              {t.login}
            </button>
            <button
              onClick={() => onSelectView('auth_signup')}
              className="group relative inline-flex items-center justify-center gap-2 px-5 py-2 text-sm font-bold text-white bg-indigo-600 rounded-full hover:bg-indigo-500 transition-all overflow-hidden cursor-pointer"
            >
              <span className="relative z-10 flex items-center gap-2">
                {t.startFree} {lang === 'ar' ? <ArrowLeft className="w-4 h-4" /> : <ArrowRight className="w-4 h-4" />}
              </span>
            </button>
          </div>
        </div>
