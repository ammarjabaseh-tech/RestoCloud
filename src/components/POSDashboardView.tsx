...
const posTranslations = {
  ar: {
    ...
    selectTableAlert: "يرجى اختيار رقم الطاولة",
    dineInLabel: "طاولة",
    takeawayLabel: "سفري",
    deliveryLabel: "توصيل",
    generalCashier: "الكاشير",
    reviewInvoice: "فاتورة الكاشير",
    posTitle: "كاشير POS",
    trialAlert: "⏳ تجريبي:",
    days: "يوم",
    activeCashier: "الكاشير",
    newSale: "🛒 بيع جديد",
    ordersList: "📋 الطلبات",
    invoiceHistory: "الفواتير",
    ...
    draftInvoice: "مبدئية",
    holdInvoice: "تعليق",
    completing: "جاري الدفع...",
    completeAndPrint: "دفع وطباعة",
    activeOrders: "النشطة",
    pendingOrders: "المعلقة",
    preparingOrders: "التحضير",
    readyOrders: "الجاهزة",
    archivedOrders: "الأرشيف",
    ordersSearchPlaceholder: "ابحث بالطلب أو الاسم...",
    orderStatusPending: "معلق",
    orderStatusPreparing: "تحضير",
    orderStatusReady: "جاهز",
    orderStatusDelivered: "مكتمل",
    orderStatusCancelled: "ملغي",
    orderNote: "💡 ملاحظة:",
    finalTotal: "الإجمالي",
    cancelOrder: "إلغاء الطلب",
    approveBtn: "موافقة",
    printKitchen: "طابعة المطبخ",
    readyBtn: "جاهز",
    printInvoice: "طباعة الفاتورة",
    deliveredBtn: "تم التسليم",
    reprintBtn: "إعادة طباعة",
    noOrdersTitle: "لا توجد طلبات هنا",
    noOrdersDesc: "ستظهر الطلبات الحية والنشطة هنا بمجرد وصولها.",
    printPreviewTitle: "معاينة الفاتورة",
    printPreviewDraftTitle: "الفاتورة المبدئية",
    printerLabel: "الطابعة:",
    closeAndNew: "إغلاق وطلب جديد",
    printReceiptBtn: "طباعة الإيصال 🖨️",
    historyTitle: "سجل الفواتير",
    historyDesc: "عرض وطباعة الفواتير الصادرة",
    issuedInvoices: "الفواتير الصادرة",
    pendingMobileOrders: "طلبات المنيو",
    historySearchPlaceholder: "ابحث برقم الفاتورة...",
    refreshBtn: "تحديث",
    loadingHistory: "جاري التحميل...",
    noMatchingInvoices: "لا توجد فواتير مطابقة",
    noMatchingInvoicesDesc: "ستظهر هنا فواتير المطعم وطلبات المنيو",
    cashPayment: "نقدي",
    cardPayment: "شبكة",
    pendingPayment: "بانتظار موافقة الكاشير",
    deferredPayment: "آجل",
    declineOrder: "رفض الطلب",
    approveAndPrepare: "تحضير",
    closeBtn: "إغلاق"
  },
  en: {
...
export const POSDashboardView: React.FC<POSDashboardViewProps> = ({
  ...
  // Cashier Active Ordering Session State
  const [activeOrderSession, setActiveOrderSession] = useState<{
  ...
  const [deliveryTab, setDeliveryTab] = useState<"ready" | "active" | "completed">("ready");
  ...
  const handleStartOrderSession = (type: "dine_in" | "takeaway" | "delivery", tableNum?: number) => {
    ...
    setActiveOrderSession({ type, tableNumber: tableNum });
  };
        ...
        <div className="p-4 bg-slate-100 text-slate-800 flex items-center justify-between border-b border-slate-200">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[9px] text-slate-500">{posTranslations[lang].totalItems}: {cart.reduce((sum, i) => sum + i.quantity, 0)}</p>
            </div>
          </div>
