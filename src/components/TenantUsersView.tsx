...
const usersTranslations = {
  ar: {
    panelTitle: "الموظفون والصلاحيات",
    panelSubtitle: "إدارة فريق العمل وتحديد صلاحيات الوصول للنظام",
    addBtn: "إضافة موظف",
    owners: "المالكون",
    managers: "المدراء",
    cashiers: "الكاشير",
    ...
    listSubtitle: "المستخدمون وصلاحياتهم",
    totalCount: "الإجمالي:",
    usersUnit: "موظف",
    userLabel: "موظف",
    ...
    thEmployee: "الموظف",
    thRole: "الدور",
    thContacts: "بيانات الدخول",
    thPermissions: "الصلاحيات",
    thStatus: "الحالة",
    thActions: "الإجراءات",
    activeStatus: "نشط",
    ...
    permPOS: "🖥️ الكاشير",
    permMenu: "🍴 المنيو وطاولات",
    permReports: "📊 التقارير والذكاء الاصطناعي",
    permUsers: "👥 الموظفون",
    permSettings: "⚙️ الإعدادات",
    modalAddTitle: "إضافة موظف جديد",
    modalEditTitle: "تعديل الموظف",
    inputName: "اسم الموظف *",
    inputNamePlaceholder: "اسم الموظف...",
    inputRole: "الدور الوظيفي *",
